...
import { RunsPageV2Component } from './runs-page-v2.component';
import type { RunDetailVM } from '../run-drawer/run-drawer.models';
import type { RunStatus, SortState } from '../../../core/models';
import type { RunsSummaryVM, SummaryLens } from '../runs-summary/runs-summary-v2.models';
...
function setup(initialRuns: RunDetailVM[] = [failedRun, succeededRun, runningRun]) {
  ...
  const fixture = TestBed.createComponent(RunsPageV2Component);
  fixture.detectChanges();

  const component = fixture.componentInstance as RunsPageV2Component & {
...
describe('RunsPageV2Component — container tests', () => {
