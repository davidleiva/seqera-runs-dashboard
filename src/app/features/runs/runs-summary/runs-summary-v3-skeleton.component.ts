...
/**
 * Loading placeholder for `RunsSummaryV3Component` — same card footprint (verdict
 ...
 */
@Component({
  selector: 'app-runs-summary-v3-skeleton',
  standalone: true,
  ...
  `,
  styleUrl: './runs-summary-v3-skeleton.component.scss',
  host: {
...
export class RunsSummaryV3SkeletonComponent {
