import type { RunsSummaryVM } from './runs-summary-v2.models';
...
export const summarySample: RunsSummaryVM = {
  ...
  succeededWithIssues: 1, // needsAttention derived = 2 + 1 = 3
  successRatePct: 57,
  totalCostLabel: '$0.13',
  insight: null,
};
...
export const summaryHealthy: RunsSummaryVM = {
  ...
  succeededWithIssues: 0, // needsAttention derived = 0 → calm verdict
  successRatePct: 100,
  totalCostLabel: '$0.41',
  insight: null,
};
