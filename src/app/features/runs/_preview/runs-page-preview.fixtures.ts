...
> = {
  ...
  resources: null,
  topProcesses: [],
  // None of these preview fixtures exercise the guide-to-solution layer — see
  // `run-drawer.fixtures.ts` for the dedicated FailedWithKnownIssue/FailedNoMatch/
  // FailedNoTasks stories that do.
  knownIssue: null,
  failedTask: null,
};
